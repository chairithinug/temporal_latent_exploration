...
x_hat_paths = {
    'triplet': 'interpolation/reconstruction_triplet.npy',
    'data': 'interpolation/reconstruction_data.npy',
    'pca_per_attr': 'interpolation/reconstruction_pca_per_attr.npy',
    '2d': 'interpolation/reconstruction_2d.npy',
}
...
plot_errors(all_results, title_prefix="Interpolation Error Comparison")